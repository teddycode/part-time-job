        ...
        <div class="user-nav-item">
            <dl>
                <div class="user-nav-item-div">
                    ...
                    <dd class="active"><a href="../href/myjb.html"><i class="iconfont"></i>我的举报</a></dd>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group has-feedback feedback-left">
                        <label class="col-xs-12" >处理结果</label>
...
<script type="text/javascript" src="<%=basePaths%>resource/pro/pt/jb.js"></script>
