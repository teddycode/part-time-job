        ...
        <div class="user-nav-item">
            <dl>
                <div class="user-nav-item-div">
                    ...
                    <dd  class="active"><a href="../href/myfbjobs.html"><i class="iconfont"></i>我发布的兼职</a></dd>
...
<div class="modal fade timer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="timer">设置失效时间</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group has-feedback feedback-left">
                        <label class="col-xs-12" >请输入有效小时数</label>
                        <input type="hidden"  id="jidse" name="jid">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" onclick="tim()" class="btn btn-primary">点击保存</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="<%=basePaths%>resource/pro/pt/mypart_time_job.js"></script>
