...
<div class="w1180 bgWhite shadow clearfix">
        ...
        <div class="user-nav-item">
            <dl>
                <div class="user-nav-item-div">
                    <dd class="active"><a href="../href/myuser.html"><i class="iconfont"></i>个人资料</a></dd>
                    <dd><a href="../href/myjobs.html"><i class="iconfont"></i>我的兼职</a></dd>
    ...
    <div class="userRightCon">
        ...
        <div class="ucon">
            <form id="form1">
                <table class="ucTable" border="0" cellspacing="0" cellpadding="0">
                    <tbody>

                    <tr>
                        <td class="uLabel"><span>*</span>密码：</td>
                        <input type="hidden" id="userids" name="userid" value="${sessionScope.user.userid}">

                        <td><input name="user_name" class="txtInput1" id="user_name" type="password"  value="${sessionScope.user.userpwd}"></td>
                    </tr>
                    <tr>
                        <td class="uLabel"><span>*</span>性别：</td>
                        <td>
                            <div class="form-group has-feedback feedback-left">
                                <select class="form-control example-select" id="sh" name="sex" >
                    ...
                    <tr>
                        <td class="uLabel"><span>*</span>电话：</td>
                        <td><input type="text" id="phones" name="phone" value="${sessionScope.user.phone}"></td>
                    </tr>
                    <tr>
                        <td class="uLabel"><span>*</span>余额：</td>
                        <td><input type="text" disabled id="money" name="money" value="${sessionScope.user.money}"></td>

                    </tr>
                    <tr>
                        <td class="uLabel"><span>*</span>我想要找的兼职类型：</td>
                        <td><div class="form-group has-feedback feedback-left">
                            <select class="form-control type" id="typeids" name="typeid" >
                            </select>
                        </div></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input class="submitBtn" onclick="sub()" id="submitBtn" type="button" value="提交"> <input data-toggle="modal" data-target=".cz" class="submitBtn"  id="su" type="button" value="充值"></td>
                        <td colspan="2"></td>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group has-feedback feedback-left">
                        ...
                        <input type="text"  class="form-control example-email-input"  value="${sessionScope.user.username}" id="username" name="username" />

                    </div>
                    <div class="form-group has-feedback feedback-left">
                        <label class="col-xs-12" >密码</label>
                        <input type="password"  class="form-control example-email-input"  value="${sessionScope.user.userpwd}" id="userpwd" name="userpwd" />
...
<div class="modal fade cz" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="cz">请输入充值金额</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group has-feedback feedback-left">
                        <label class="col-xs-12" >请输入金额</label>
                        <input type="text"  onkeyup="value=value.replace(/[^\d]/g,'') "

                               onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"   class="form-control example-email-input"  id="num" name="num" />
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" onclick="cz()" class="btn btn-primary">立即充值</button>
                </div>
            </div>
        </div>
    </div>
...
function cz(){
    $.ajax({
        ...
        data:{userid:$("#userid").val()},
        success:function(data){
        console.log(accAdd(data.data[0].money,$("#num").val()))
                $.ajax({
                    url: "../user/upd.html",
                    dataType: "json",
                    tyoe: "post",
                    data: {userid: $("#userid").val(),money:accAdd(data.data[0].money,$("#num").val())
                    },
                    success: function (data) {
                        alert("充值成功")
