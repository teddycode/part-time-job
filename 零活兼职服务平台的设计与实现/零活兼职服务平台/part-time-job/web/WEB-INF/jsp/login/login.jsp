        ...
        <div class="login-center">
            ...
            <form action="#!" method="post">
                ...
                <footer class="col-sm-12 text-center">
                    <p class="m-b-0">没有账号？ <a href="../href/regist.html">点击我</a>立即注册</p>
                </footer>
            </form>
            <hr>
        </div>
    ...
    if($.trim(txtPwd)!="" &&$.trim(txtUser) != "") {
        $.ajax({
            ...
            success: function (data) {
                if (data.data === 0) {
                    lightyear.notify("登录成功", 'success', 5000, 'mdi mdi-emoticon-happy', 'top', 'center');
                    lightyear.loading('hide');
                    window.location.href = "../href/index.html";
                }else
                {
                    lightyear.notify("用户名或密码错误", 'warning', 5000, 'mdi mdi-emoticon-happy', 'top', 'center');
                    lightyear.loading('hide');
                }
            }
        })
